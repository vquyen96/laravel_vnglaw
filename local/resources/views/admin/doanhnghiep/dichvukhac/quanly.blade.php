...
@stop
<h1 class="page-header">Doanh Nghiệp</h1>

<div id="main">
	<div id="button" class="btn btn-primary">
		<a href="{{asset('quanlydoanhnghiep/add')}}" style="color: #fff;text-decoration: none;">Thêm Mới</a>
	</div>
	<table data-toggle="table" data-search="true">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<div>
						<a href="{{asset('quanlydoanhnghiep/edit/'.$item->id)}}">Chi tiết</a>
					</div>
				</td>
				
				<td>
					<div class="icon">
						<a onclick="return Xoa();" href="{{asset('quanlydoanhnghiep/delete/'.$item->id)}}"><img src="../images/210_img1.png" width="40px" height="40px"></a>
					</div>
				</td>
			</tr>
			@endforeach
