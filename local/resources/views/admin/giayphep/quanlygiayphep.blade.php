...
@stop
<h1 class="page-header">Giấy Phép</h1>

<div id="main">
	<div id="button" class="btn btn-primary">
		<a href="{{asset('quanlygiayphep/add')}}" style="color: #fff;text-decoration: none;">Thêm Mới</a>
	</div>
	<table data-toggle="table" data-search="true">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<div>
						<a href="{{asset('quanlygiayphep/show/'.$item->id)}}">Chi tiết</a>
					</div>
				</td>
				
				<td>
					<div class="icon">
						<a onclick="return Xoa();" href="{{asset('quanlygiayphep/delete/'.$item->id)}}"><img src="../images/210_img1.png" width="40px" height="40px"></a>
					</div>
				</td>
			</tr>
			@endforeach
